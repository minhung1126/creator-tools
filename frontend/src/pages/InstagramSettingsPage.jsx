...
export default function InstagramSettingsPage() {
  ...
  const disconnect = async () => {
    if (!window.confirm('確定要中斷 Instagram 連線並刪除已儲存的 Token？')) return;
    try {
