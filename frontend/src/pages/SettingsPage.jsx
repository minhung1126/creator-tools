    ...
    <div className="section-gap settings-page">
      ...
      <div className="glass-panel card-padding settings-card card-stack">
        <div className="card-header">
          <div className="card-header-title"><Key size={20} color="var(--primary)" /><h3>控制台登入與 Google Sheet 授權</h3></div>
          {authUser
        ...
        {sysSettings.redirect_uri && <div className="settings-code-block">
          <p><strong>Google Authorized Redirect URI：</strong></p>
